...
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which have a gold requirement will not be turned-in automatically.|n|nYou can hold the shift key down when you talk to a quest giver to override this setting."] = "Si está seleccionado, las misiones serán seleccionadas, aceptadas y entregadas automáticamente.|n|nLas misiones que tienen un requisito de oro no se entregarán automáticamente.|n|nPuede mantener presionada la tecla shift cuando hable con un asignador de misiones para anular esta configuración."
