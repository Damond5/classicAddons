...
L["If checked, you will be able to scale and move the map.|n|nScale the map by dragging the scale handle in the bottom-right corner.|n|nMove the map by dragging the border and frame edges.  If you have removed the map border, a drag button will be shown in the top-left corner."] = "Si está seleccionado, podrá escalar y mover el mapa.|n|nEscale el mapa arrastrando el controlador de escala en la esquina inferior derecha.|n|nMueva el mapa arrastrando el borde y los bordes del marco. Si ha eliminado el borde del mapa, se mostrará un botón de arrastre en la esquina superior izquierda."
...
L["If checked, you will be able to scale and move the map.|n|nScale the map by dragging the scale handle in the bottom-right corner.|n|nMove the map by dragging the border and frame edges.  If you have removed the map border, a drag button will be shown in the top-left corner."] = "Si cette option est cochée, vous pourrez redimensionner et déplacer la carte.|n|nMettez la carte à l'échelle en traîner la poignée d'échelle dans le coin inférieur droit.|n|nDéplacez la carte en traîner la bordure et les bords du cadre. Si vous avez supprimé la bordure de la carte, un bouton de glisser apparaîtra dans le coin supérieur gauche."
...
L["Druid only flight point to Darnassus"] = "Druida apenas ponto de vôo para Darnassus"
L["Druid only flight point to Thunder Bluff"] = "Druida apenas ponto de vôo para Penhasco do Trovão"
L["Dun Morogh"] = "Dun Morogh"
L["Dungeon"] = "Masmorra"
L["Durotar"] = "Durotar"
...
L["If checked, flight points will be shown."] = "Se marcado, os pontos de vôo serão mostrados."
...
L["If checked, you will be able to scale and move the map.|n|nScale the map by dragging the scale handle in the bottom-right corner.|n|nMove the map by dragging the border and frame edges.  If you have removed the map border, a drag button will be shown in the top-left corner."] = "Se marcado, você poderá dimensionar e mover o mapa.|n|nDimensione o mapa arrastando a alça da escala no canto inferior direito.|n|nMova o mapa arrastando as bordas da borda e do quadro. Se você removeu a borda do mapa, um botão de arrastar será mostrado no canto superior esquerdo."
...
L["Show flight points"] = "Pontos de vôo"
